...
#define PMUGRF_BASE	((struct rk3568_pmugrf *)0xfdc20000)
#define DDRGRF_BASE	((struct rk3568_ddrgrf *)0xfdc40000)
#define SCRU_BASE	((void *)0xfdd10000)
#define SYSSGRF_BASE	((void *)0xfdd18000)
#define CRU_BASE	((struct rk3568_cru *)0xfdd20000)
#define MSCH_BASE	((struct msch_regs *)0xfe100000)
#define UPCTL2_BASE	((void *)0xfe250000)
#define DDRPHY_BASE	((void *)0xfe800000)
			    ...
			    u32 phy_psrstn)
{
	...
	rk_clrsetreg(SCRU_BASE + SCRU_SOFTRST_CON02, PRESETN_DDR_UPCTL_MASK,
...
int sdram_init(void)
{
	...
	dram_info.phy    = DDRPHY_BASE;
	dram_info.pctl   = UPCTL2_BASE;
	dram_info.sgrf   = SYSSGRF_BASE;
	dram_info.cru    = CRU_BASE;
	dram_info.msch   = MSCH_BASE;
	dram_info.ddrgrf = DDRGRF_BASE;
	dram_info.pmugrf = PMUGRF_BASE;
...
{
	static struct rk3568_pmugrf * const pmugrf = PMUGRF_BASE;
