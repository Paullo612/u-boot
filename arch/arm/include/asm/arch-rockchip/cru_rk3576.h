...
#define RK3576_SCRU_BASE		0x10000
...
#define RK3576_VPLL_CON(x)		((x) * 0x4 + 0x160)
#define RK3576_AUPLL_CON(x)		((x) * 0x4 + 0x180)
#define RK3576_CPLL_CON(x)		((x) * 0x4 + 0x1a0)
#define RK3576_GPLL_CON(x)		((x) * 0x4 + 0x1c0)
#define RK3576_PPLL_CON(x)		((x) * 0x4 + RK3576_PHP_CRU_BASE + 0x200)
#define RK3576_SPLL_CON(x)		((x) * 0x4 + RK3576_SCRU_BASE + 0x4220)
#define RK3576_LPLL_CON(x)		((x) * 0x4 + RK3576_CCI_CRU_BASE + 0x40)
#define RK3576_MODE_CON0		0x280
#define RK3576_SPLL_MODE_CON0		(RK3576_SCRU_BASE + 0x4280)
